...
from .api import (
            ...
            StudyChoicesAPIView,
            SchoolNoticeTypeChoicesAPIView,
            SchoolNoticeBoardStatusChoicesAPIView,
            InstitutionStatusChoicesAPIView,
            InstitutionTypeChoicesAPIView,
            PsychomotorChoicesAPIView,
            TermChoicesAPIView,
            SchoolHeadReportStatusChoicesAPIView,
            OnlineAdmissionStatusChoicesAPIView,
            AttendanceStatusChoicesAPIView,
            CoursesStatusChoicesAPIView,
            StudyNotesStatusChoicesAPIView,
            StaffTypeChoicesAPIView,
            StudyNotesApprovalStatusChoicesAPIView,
            GenderChoicesAPIView,
            UserTitleChoicesAPIView,
            YearChoicesAPIView,
            UserStatusChoicesAPIView,
            StudentClassStatusChoicesAPIView,
            BooleanChoicesAPIView,
            LanguageChoicesAPIView,
            CourseFormatChoicesAPIView,
            NumberOfAnnouncementsChoicesAPIView,
            FilesUploadsChoicesAPIView,
            CourseGroupsChoicesAPIView,
            ...
            CourseEnrollmentStatusChoicesAPIView
...
urlpatterns = [
    ...
    path('course-enrollment-status-choices/', CourseEnrollmentStatusChoicesAPIView.as_view(), name='course-enrollment-status-choices'),
    ...
    path('general-grading-type-choices/', GeneralGradingTypeChoicesAPIView.as_view(), name='general-grading-type-choices'),
    path('course-grading-type-choices/', CourseGradingTypeChoicesAPIView.as_view(), name='course-grading-type-choices'),
    path('course-rating-choices/', CourseRatingChoicesAPIView.as_view(), name='course-rating-choices'),
    path('course-layout-choices/', CourseLayoutChoicesAPIView.as_view(), name='course-layout-choices'),
    path('course-groups-choices/', CourseGroupsChoicesAPIView.as_view(), name='course-groups-choices'),
    path('file-uploads-choices/', FilesUploadsChoicesAPIView.as_view(), name='file-uploads-choices'),
    path('number-of-announcements-choices/', NumberOfAnnouncementsChoicesAPIView.as_view(), name='number-of-announcements-choices'),
    path('course-format-choices/', CourseFormatChoicesAPIView.as_view(), name='course-format-choices'),
    path('language-choices/', LanguageChoicesAPIView.as_view(), name='language-choices'),
    path('boolean-choices/', BooleanChoicesAPIView.as_view(), name='boolean-choices'),
    path('user-status-choices/', UserStatusChoicesAPIView.as_view(), name='user-status-choices'),
    path('year-choices/', YearChoicesAPIView.as_view(), name='year-choices'),
    path('study-choices/', StudyChoicesAPIView.as_view(), name='study-choices'),
    path('school-notice-type-choices/', SchoolNoticeTypeChoicesAPIView.as_view(), name='school-notice-type-choices'),
    path('school-noticeboard-staus-choices/', SchoolNoticeBoardStatusChoicesAPIView.as_view(), name='school-noticeboard-staus-choices'),
    path('institutions-status-choices/', InstitutionStatusChoicesAPIView.as_view(), name='institutions-status-choices'),
    path('institution-type-choices/', InstitutionTypeChoicesAPIView.as_view(), name='institution-type-choices'),
    path('psychomotor-choices/', PsychomotorChoicesAPIView.as_view(), name='psychomotor-choices'),
    ...
    path('course-status-choices/', CoursesStatusChoicesAPIView.as_view(), name='course-status-choices'),
