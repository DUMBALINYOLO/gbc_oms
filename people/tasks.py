...
from gbc.celery import app
from celery import Task
from io import BytesIO
import datetime


# @shared_task  # TODO delete after background tasks are tested
...
class Email(Task, EmailMessage):
    ...
    def register(self, request):
        ...
        self.subject = 'Welcome! - to Gerere Business College'
    ...
    def reset(self, request):
        ...
        self.set_user(request)
        self.subject = 'Change of password - Vibromontajes'
