...
export default function courses(state = initialState, action){
    switch(action.type){
        ...
        case CREATE_STUDENT_COURSE_ENROLLMENT_START:
            return createStudentCourseEnrollmentStart(state, action);
        ...
        case GET_ADMIN_TOPICS_START:
            return getAdminTopicListStart(state, action);
