...
import {closeReopenedTicket} from '../../actions/tickets/customertickets';
...
function Comments(props) {
  ...
  const {comments, userName, token, data, closeReopenedTicket} = props;
              ...
              <div className="align-box-row mt-3">
                <div className="ml-auto">
                  <Button
                    ...
                    variant="contained"
                    color="primary"
                    onClick={(e) => closeReopenedTicket(id, data, token)}
                   >
                    CLOSE
                  </Button>
                </div>
