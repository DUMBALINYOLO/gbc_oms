...
import {getCustomerReOpenedTickets} from '../../actions/tickets/customerreopenedtickets';
import AOS from "aos";
...
const CustomerReOpenedTickets = props => {
  ...
  useEffect(() => {
    if(!props.fetched) {
        props.getCustomerReOpenedTickets(token)
  ...
  const handleClick = id =>{
    history.push(`/customer-reopened-tickets/${id}`)
  }
...
const mapStateToProps = state =>({
    records: state.customertickets.customerreopenedtickets,
