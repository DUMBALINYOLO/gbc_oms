...
import {getCustomerOpenTickets} from '../../actions/tickets/customertickets';
import AOS from "aos";
...
const Tickets = props => {
  ...
  useEffect(() => {
    if(!props.fetched) {
        props.getCustomerOpenTickets(token)
  ...
  return (
    <>
      ...
      <Paper className={classes.pageContent} data-aos="fade-left">
          ...
          <div className="text-center text-lg-left" style={{paddingBottom: '40px'}}>
            <Dialog
            ...
            >
                  <CreateTicket
                      ticketDialog={setSeriesDialog}
                      getTickets={props.getCustomerOpenTickets}
                  />
            </Dialog>
              <Button
                size="small"
              ...
              >
                ...
                <span className="btn-wrapper--label">OPEN TICKET</span>
              </Button>
            </div>
...
const mapStateToProps = state =>({
    records: state.customertickets.customeropentickets,
