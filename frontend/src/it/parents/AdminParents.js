...
const AdminParents = (props) => {
    ...
    const saveProduct = (e) => {
        ...
        let _record = {...record};
        if (record.id) {
            props.addBursar(_record, token)
            setNewRecord(_record)
            props.getAdminParents(token);
            toast.current.show({ severity: 'success', summary: 'Successful', detail: 'PARENT CREATED', life: 3000 });
        }
        setProductDialog(false);
        setRecord(emptyRecord);
    }
    ...
    const deleteProduct = () => {
        ...
        setDeleteProductDialog(false);
        setRecord(emptyRecord);
        toast.current.show({ severity: 'success', summary: 'Successful', detail: 'Parent Deleted', life: 3000 });
    }
    ...
    const deleteSelectedProducts = () => {
        ...
        toast.current.show({ severity: 'success', summary: 'Successful', detail: 'Parents Deleted', life: 3000 });
    }
    ...
    const header = (
        <div className="table-header">
            <h1 className="p-m-0">MANAGE PARENTS</h1>
      ...
      <InformationTechnologyLayout>
        <Paper className={classes.pageContent}>
            <div className="datatable-crud-demo">
                ...
                <Dialog visible={productDialog} style={{ width: '500px' }} header="PARENT FORM" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                  <Form>
                    <Grid container>
                      <Grid item xs={12}>
                        <Controls.Input
