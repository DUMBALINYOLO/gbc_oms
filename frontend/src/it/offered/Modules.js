...
const Objectives = (props) => {
    ...
    const saveProduct = (e) => {
        ...
        if (record.id) {
            ...
            props.addModule(_record, token)
            props.getModules(props.id, token);
    ...
    const leftToolbarTemplate = () => {
        return (
            <React.Fragment>
                <Button label="ADD" className="p-button-warning p-mr-2" onClick={openNew} />
            </React.Fragment>
        )
    }
        ...
        <Paper className={classes.pageContent}>
            <div className="datatable-crud-demo">
                ...
                <Dialog visible={productDialog} style={{ width: '500px' }} header="OBJECTIVE FORM" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                        ...
                        <div className="p-field p-col-12 p-md-12">
                            <label htmlFor="name">LONGEVITY</label>
                            <InputText id="longevity"
                                value={record.longevity}
                                onChange={(e) => onInputChange(e, 'longevity')}
                                required
                                autoFocus
                                type='number'
                            />
