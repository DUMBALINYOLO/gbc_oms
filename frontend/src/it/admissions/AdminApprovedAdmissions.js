...
const AdminApprovedAdmissions = (props) => {
    ...
    let emptyAdminApprovedAdmission = {
      status: '',
      enr_klass: '',
      stdnt: '',
    };
    ...
    const [record, setRecord] = useState(emptyAdminApprovedAdmission);
    ...
    const openNew = () => {
        setRecord(emptyAdminApprovedAdmission);
        setSubmitted(false);
    ...
    const deleteProduct = () => {
        ...
        setDeleteProductDialog(false);
        setRecord(emptyAdminApprovedAdmission);
        toast.current.show({ severity: 'success', summary: 'Successful', detail: 'Admin Approved Admission Deleted', life: 3000 });
    }
    ...
    const header = (
        <div className="table-header">
            <h1 className="p-m-0">MANAGE APPROVED ADMISSIONS</h1>
            ...
            <div className="datatable-crud-demo">
                ...
                <div className="card">
                    ...
                    <DataTable
                        ...
                        currentPageReportTemplate="SHOWING {first} TO {last} OF {totalRecords} APPROVED ADMISSIONS"
