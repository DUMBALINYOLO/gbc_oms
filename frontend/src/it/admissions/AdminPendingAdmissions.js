...
import { getPendingAdmissions } from '../../actions/admissions';
...
const AdminPendingAdmissions = (props) => {
    ...
    let emptyAdminPendingAdmission = {
      status: '',
      enr_klass: '',
      stdnt: '',
    };
    ...
    const [record, setRecord] = useState(emptyAdminPendingAdmission);
    ...
    const openNew = () => {
        setRecord(emptyAdminPendingAdmission);
        setSubmitted(false);
    ...
    const deleteProduct = () => {
        ...
        setDeleteProductDialog(false);
        setRecord(emptyAdminPendingAdmission);
        toast.current.show({ severity: 'success', summary: 'Successful', detail: 'Admin Pending Admission Deleted', life: 3000 });
    }
    ...
    const header = (
        <div className="table-header">
            <h1 className="p-m-0">MANAGE PENDING ADMISSIONS</h1>
            ...
            <div className="datatable-crud-demo">
                ...
                <div className="card">
                    ...
                    <DataTable
                        ...
                        currentPageReportTemplate="SHOWING {first} TO {last} OF {totalRecords} PENDING ADMISSIONS"
                ...
                <Dialog visible={deleteProductsDialog} style={{ width: '450px' }} header="Confirm" modal footer={deleteProductsDialogFooter} onHide={hideDeleteProductsDialog}>
                    <div className="confirmation-content">
                        <i className="pi pi-exclamation-triangle p-mr-3" style={{ fontSize: '2rem'}} />
                        {record && <span>Are you sure you want to delete the selected pending admission?</span>}
                    </div>
                </Dialog>
            </div>
          </Paper>
