...
import { getStudentProfile, editStudentProfile } from '../../actions/people';
...
class Profile extends React.Component {
  ...
  componentDidMount() {
    if (this.props.token !== undefined && this.props.token !== null) {
      this.props.getStudentProfile(this.props.id, this.props.token);
    }
  }
  ...
  componentWillReceiveProps(newProps) {
    if (newProps.token !== this.props.token) {
      if (newProps.token !== undefined && newProps.token !== null) {
        this.props.getStudentProfile(this.props.id, newProps.token);
      }
    }
  }
  ...
  addOrEdit = (profile, resetForm) => {
    this.props.editStudentProfile(this.props.id, profile, this.props.token);
    resetForm();
        ...
        <div>
          <List>
              ...
              <ListItem>
                ...
                <ListItemText primary={profile.phone_number} secondary="PHONE NUMBER" />
              </ListItem>
              <Divider variant="inset" />
              <ListItem>
                <ListItemAvatar>
...
const mapStateToProps = state => {
  return {
    profile: state.people.studentprofile,
    token: state.auth.token,
  };
};

const constDispatchToProps = dispatch => ({
  getStudentProfile: bindActionCreators(getStudentProfile, dispatch),
  editStudentProfile: bindActionCreators(editStudentProfile, dispatch),
