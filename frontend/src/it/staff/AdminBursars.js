...
const AdminBursars = (props) => {
    ...
    const saveProduct = (e) => {
        ...
        if (record.id) {
            ...
            props.getAdminBursars(token);
            toast.current.show({ severity: 'success', summary: 'Successful', detail: 'BURSAR CREATED', life: 3000 });
        }
        setProductDialog(false);
        setRecord(emptyRecord);
    }
    ...
    const deleteProduct = () => {
        ...
        setDeleteProductDialog(false);
        setRecord(emptyRecord);
        toast.current.show({ severity: 'success', summary: 'Successful', detail: 'Bursar Deleted', life: 3000 });
    }
    ...
    const deleteSelectedProducts = () => {
        ...
        toast.current.show({ severity: 'success', summary: 'Successful', detail: 'Bursars Deleted', life: 3000 });
    }
            ...
            <div className="datatable-crud-demo">
                ...
                <div className="card">
                    ...
                    <DataTable
                        ...
                        currentPageReportTemplate="SHOWING {first} TO {last} OF {totalRecords} BURSARS"
