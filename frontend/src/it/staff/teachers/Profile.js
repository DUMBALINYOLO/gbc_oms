...
import {getTeacherProfile, editTeacherProfile} from "../../../actions/people";
...
class Profile extends React.Component {
  ...
  componentDidMount() {
    if (this.props.token !== undefined && this.props.token !== null) {
      this.props.getTeacherProfile(this.props.id, this.props.token);
    }
  }
  ...
  componentWillReceiveProps(newProps) {
    if (newProps.token !== this.props.token) {
      if (newProps.token !== undefined && newProps.token !== null) {
        this.props.getTeacherProfile(this.props.id, newProps.token);
      }
    }
  }
  ...
  addOrEdit = (profile, resetForm) => {
    this.props.editTeacherProfile(this.props.id, profile, this.props.token);
    resetForm();
...
const mapStateToProps = state => {
  return {
    profile: state.people.teacherprofile,
    token: state.auth.token,
  };
};

const constDispatchToProps = dispatch => ({
  getTeacherProfile: bindActionCreators(getTeacherProfile, dispatch),
  editTeacherProfile: bindActionCreators(editTeacherProfile, dispatch),
