...
import DumbalinyoloDrawer from "./DumbalinyoloDrawer";

import Main from "./Main";
import Header from "./Header";
import DumbalinyoloRightPanel from "../../components/panels/DumbalinyoloRightPanel";
...
const Layout = (props) => {
  ...
  return (
    ...
    >
      <Header />
      <DumbalinyoloDrawer drawerWidth={240} />
      <DumbalinyoloRightPanel/>
