...
import { getAdminFinishedCourse } from '../../../actions/courses';
...
class Course extends React.Component {
  ...
  componentDidMount() {
    if (this.props.token !== undefined && this.props.token !== null) {
      this.props.getAdminFinishedCourse(this.props.match.params.id, this.props.token);
    }
  }
  ...
  componentWillReceiveProps(newProps) {
    if (newProps.token !== this.props.token) {
      if (newProps.token !== undefined && newProps.token !== null) {
        this.props.getAdminFinishedCourse( this.props.match.params.id, newProps.token);
      }
    }
  }
...
const mapStateToProps = state => ({
  course: state.courses.adminfinishedcourse,
