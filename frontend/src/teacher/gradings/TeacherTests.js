...
const Tests = (props) => {
    ...
    const deleteProduct = () => {
        ...
        setDeleteProductDialog(false);
        setRecord(emptyRecord);
        toast.current.show({ severity: 'success', summary: 'Successful', detail: 'Test Deleted', life: 3000 });
    }
    ...
    const deleteSelectedProducts = () => {
        ...
        toast.current.show({ severity: 'success', summary: 'Successful', detail: 'Tests Deleted', life: 3000 });
    }
    ...
    const leftToolbarTemplate = () => {
        return (
            <React.Fragment>
                <Button label="CREATE TEST" icon="pi pi-plus" className="p-button-success p-mr-2" onClick={openNew} />
            </React.Fragment>
        )
    }
    ...
    const header = (
        <div className="table-header">
            <h1 className="p-m-0">MANAGE TESTS</h1>
      ...
      <TeacherLayout>
        <Paper className={classes.pageContent}>
            <div className="datatable-crud-demo">
                ...
                <Dialog visible={productDialog} style={{ width: '500px' }} header="TEST FORM" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                  <Form>
                    <Grid container>
                      <Grid item xs={6}>
                        <Controls.Input
...
export default connect(
  mapStateToProps,
  {getClasses, getGeneralGradingTypeChoices, getTeacherProfiles, getSubjects, getAdminStudentTests, addGrade, editGrade} )
  (Tests);
