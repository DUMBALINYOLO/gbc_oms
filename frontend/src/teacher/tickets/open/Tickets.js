...
import {getAssignedOpenTickets} from '../../../actions/tickets/assignedopentickets';
import AOS from "aos";
...
const Tickets = props => {
  ...
  useEffect(() => {
    if(!props.fetched) {
        props.getAssignedOpenTickets(token)
  ...
  const handleClick = id =>{
    history.push(`/teacherdashboard/open-tickets/${id}`)
  }
...
const mapStateToProps = state =>({
    records: state.assignedopentickets.assignedopentickets,
