...
import {getAssignedClosedTickets} from '../../../actions/tickets/assignedclosedtickets';
import AOS from "aos";
...
const ClosedTickets = props => {
  ...
  useEffect(() => {
    if(!props.fetched) {
        props.getAssignedClosedTickets(token)
  ...
  const handleClick = id =>{
    history.push(`/teacherdashboard/closed-tickets/${id}`)
  }
...
const mapStateToProps = state =>({
    records: state.assignedclosedtickets.assignedclosedtickets,
