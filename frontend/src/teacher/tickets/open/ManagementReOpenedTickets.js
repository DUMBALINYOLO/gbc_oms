...
import {getAssignedReOpenedTickets} from '../../../actions/tickets/assignedreopenedtickets';
import AOS from "aos";
...
const ReOpenedTickets = props => {
  ...
  useEffect(() => {
    if(!props.fetched) {
        props.getAssignedReOpenedTickets(token)
  ...
  const handleClick = id =>{
    history.push(`/teacherdashboard/reopened-tickets/${id}`)
  }
...
const mapStateToProps = state =>({
    records: state.assignedreopenedtickets.assignedreopenedtickets,
