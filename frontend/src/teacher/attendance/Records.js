...
const Records = (props) => {
    ...
    const leftToolbarTemplate = () => {
        return (
            <React.Fragment>
                <Button label="ATTENDANCE RECORDS" icon="pi pi-plus" className="p-button-success p-mr-2" />
            </React.Fragment>
        )
    }
    ...
    const header = (
        <div className="table-header">
            <h1 className="p-m-0">MANAGE ATTENDANCE RECORDS</h1>
...
export default connect(
  mapStateToProps,
  {editAttendanceRecord, getAdminAttendanceRecords, getAttendanceStatusChoices} )
  (Records);
